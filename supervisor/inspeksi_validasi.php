    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Inspeksi Validasi</h1>
                </div>
                 <!-- end  page header -->
            </div>
                                    ...
                                    <tbody>
                                     <?php
                                            ...
                                            ?>
                                                  ...
                                                  <td><img src="../admin/assets/img/<?php echo $row['gambar_perbaikan'];?>" height="50"></td>
                                                  <td><?php echo $row['jenis_insop']; ?></td>
                                                  <td><?php echo $row['lokasi']; ?></td>
                                                  <td><?php echo $row['desk']; ?></td>
                                                   <td><img src="../admin/assets/img/<?php echo $row['gambar'];?>" height="50"></td>
                                                                  ...
                                                                  <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                      ...
                                                                      <div class="modal-body">
                                                                        <form action="fungsi_inspeksi.php?act=validasi&id=<?php echo $row['id_inscl']; ?>" method="post" role="form">
                                                                          <?php
                                                                          $id_inscl = $row['id_inscl'];
                                                                          $query = "SELECT * FROM inspeksi_close WHERE id_inscl='$id_inscl'";

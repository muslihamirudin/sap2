 ...
 <div class="head" style="padding: 3mm; border: 1px solid;" align="center"><span style="font-size: 14px" >PROBLEM IDENTIFICATION and CORRECTIVE ACTION ( PICA ) CLOSE</span> </div>
	...
	if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
		while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
            ...
            echo "<td style= 'text-align: center; width=85px;'><img src=../admin/assets/img/".$data['foto_perbaikan']."></td>";
            ...
            echo "<td style= 'text-align: center; width=85px;'><img src=../admin/assets/img/".$data['foto']."></td>";

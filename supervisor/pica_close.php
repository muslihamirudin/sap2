    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">PICA Close</h1>
                </div>
                 <!-- end  page header -->
            </div>
                                    ...
                                    <tbody>
                                       <?php include ('koneksi.php'); 
                                              ...
                                              while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                                                ...
                                                echo "<td><img src=../admin/assets/img/".$data['foto_perbaikan']." height=50></td>";
                                                echo "<td>".fungsi_tanggal($data['tanggal'])."</td>";
                                                echo "<td>".fungsi_tanggal($data['due_tanggal'])."</td>";
                                                echo "<td>".$data['lokasi']."</td>";
                                                echo "<td>".$data['desc_bahaya']."</td>";
                                                echo "<td><img src=../admin/assets/img/".$data['foto']." height=50></td>";

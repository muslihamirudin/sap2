...
<head>
    ...
    <title>S A P | PICA Validation </title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Halaman Validasi</h1>
                </div>
                 <!-- end  page header -->
            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                            ...
                                            ?>
                                                  ...
                                                  <td><img src="assets/img/<?php echo $row['foto_perbaikan'];?>" height="60"></td>
                                                  <td><?=  fungsi_tanggal($row['tanggal']); ?></td>
                                                  <td><?=  fungsi_tanggal($row['due_tanggal']); ?></td>
                                                  <td><?php echo $row['lokasi']; ?></td>
                                                  <td><?php echo $row['desc_bahaya']; ?></td>
                                                   <td><img src="assets/img/<?php echo $row['foto'];?>" height="60"></td>

...
<head>
    ...
    <title>S A P | Edit Data Jabatan </title>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Silakan Edit Data Jabatan
                       ...
                       <div class="panel-body">
                          ...
                          <?php
                            ...
                            $tampil= mysqli_query($koneksi, "SELECT * FROM jabatan WHERE id_jabatan='$id_jabatan'");
                            $row= mysqli_fetch_array($tampil);
                            ?>
                                <div class="col-lg-12">
                                 <form role="form" method="POST" action="jabatan_edit_proses.php">
                                        ...
                                        <a href="jabatan_tampil.php" class="btn btn-success">Batal</a>
                                    </form>
                                </div>
                            </div>
                        </div>

...
<head>
    ...
    <title>S A P | Administrator - Data Departemen </title>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                             <a href="departemen_tambah.php" class="btn btn-danger"> Tambah Data Departemen</a>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                     <thead>
                                            ...
                                            <tbody>
                                                ...
                                                $queryview = mysqli_query($koneksi, " SELECT id_departemen, departemen, head FROM departemen");
                                                while ($row = mysqli_fetch_assoc($queryview)) {
                                                    ...
                                                    ?>
                                                     ...
                                                     <tr>
                                                          ...
                                                          <td>
                                                             <a href="departemen_edit.php<?php echo '?id_departemen=' . $id_departemen; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                                             <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#hapusdepartemen<?php echo $id_departemen; ?>"><i class="fa fa-trash-o"></i></a>

                                                                  <div class="example-modal">
                                                                    <div id="hapusdepartemen<?php echo $id_departemen; ?>" class="modal fade" role="dialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"  style="display:none;">
                                                                      <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                          <div class="modal-header">
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                            <h5 class="modal-title">Konformasi Hapus Data Departemen</h5>
                                                                          </div>
                                                                          ...
                                                                          <div class="modal-footer">
                                                                            ...
                                                                            <a href="departemen_hapus.php<?php echo '?id_departemen=' . $id_departemen; ?>" class="btn btn-primary">Hapus</a>
                                                                          </div>
                                                                        </div>
                                                                      </div>
                                                                    </div>

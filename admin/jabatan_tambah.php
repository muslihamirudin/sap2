...
<head>
    ...
    <title>S A P | Tambah Data Jabatan </title>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Silakan Masukkan Data Jabatan
                       ...
                       <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                   <form role="form" method="POST" action="jabatan_tambah_proses.php">

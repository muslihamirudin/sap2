...
<head>
    ...
    <title>S A P | Edit Data Departemen </title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Data Departemen</h1>
                </div>
                <!--End Page Header -->
            </div>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Silakan Edit Data Departemen
                       ...
                       <div class="panel-body">
                          ...
                          <?php
                            ...
                            $tampil= mysqli_query($koneksi, "SELECT * FROM departemen WHERE id_departemen='$id_departemen'");
                            $row= mysqli_fetch_array($tampil);
                            ?>
                                <div class="col-lg-12">
                                  <form role="form" method="POST" action="departemen_edit_proses.php">
                                         <input type="hidden" class="form-control" name="id_departemen" value="<?php echo $row["id_departemen"]; ?>">

                                        <div class="form-group">
                                            <label>Departemen</label>
                                            <input type="text" class="form-control" name="departemen" value="<?php echo $row["departemen"]; ?>">
                                        </div>


                                        <div class="form-group">
                                            <label>Departemen</label>
                                            <input type="text" class="form-control" name="head" value="<?php echo $row["head"]; ?>">
                                        </div>
                                        <button type="submit" class="btn btn-primary">Edit</button>
                                        <a href="departemen_tampil.php" class="btn btn-success">Batal</a>
                                    </form>
                                </div>
                            </div>
                        </div>

...
<head>
    ...
    <title>S A P | Edit Observasi! </title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Observasi !</h1>
                </div>
                <!--End Page Header -->
            </div>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Silakan Edit Observasi Anda
                       ...
                       <div class="panel-body">
                            ...
                            $tampil= mysqli_query($koneksi, "SELECT * FROM observasi_open WHERE id_obsop='$id_obsop'");
                            $row= mysqli_fetch_array($tampil);
                            ?>
                                <div class="col-lg-12">
                                       <form role="form" method="POST" action="observasi_edit_proses.php" enctype="multipart/form-data">
                                        <input type="hidden" class="form-control" name="observ" value="<?php echo $_SESSION['id_karyawan']; ?>">
                                         <input type="hidden" class="form-control" name="fotolama" value="<?php echo $row["bukti"]; ?>">
                                         <input type="hidden" class="form-control" name="id_obsop" value="<?php echo $row["id_obsop"]; ?>">

                                        <div class="form-group">
                                            <label>Tanggal</label>
                                            <input type="date" class="form-control" name="tgl_obsop" value="<?php echo $row['tgl_obsop'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Batas Tanggal</label>
                                            <input type="date" class="form-control" name="due_obsop" value="<?php echo $row['due_obsop'] ?>">
                                        </div>

                                        <div class="form-group">
                                            <label>Jenis Observasi</label>
                                            <select name="jenis_obsop" class="form-control" required>
                                            <option value="<?php echo $row['jenis_obsop']; ?>"><?php echo $row['jenis_obsop']; ?></option>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type=text" class="form-control" rows="3" name="deskripsi" value="<?php echo $row['deskripsi'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Rekomendasi Tindakan</label>
                                            <input type="text" name="rec" class="form-control" rows="3" value="<?php echo $row['rec'] ?>">
                                        </div>
                                         <div class="form-group">
                                            <label>Foto</label>
                                            </br> <img src="assets/img/<?php echo $row['bukti'];?>" width="100">
                                            <span class="label-control"><?php echo $row['bukti'];?> </span>
                                            <input type="file" id="file-input" name="bukti" class="form-control-file" value="<?php echo $row['bukti']; ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="nama_kary">Nama Karyawan</label>
                                            <select class="form-control" name="nama_kary"; required>
                                            <?php
                                                include('koneksi.php');
                                                $id_picao=$_GET['id_obsop'];
                                                $rest=mysqli_query($koneksi, "SELECT observasi_open.nama_kary, nama  FROM observasi_open, karyawan WHERE observasi_open.nama_kary=karyawan.id_karyawan AND id_obsop='$id_obsop'");
                                                while ($ar = mysqli_fetch_array($rest)) {
                                                    $nama_kary = $ar['nama_kary'];
                                                    $nama = $ar['nama'];
                                                }
                                                ?>
                                            <option value="<?php echo $nama_kary; ?>"><?php echo $nama; ?></option>
                                                <?php
                                                include('koneksi.php');
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                                include('koneksi.php');
                                                $id_obsop=$_GET['id_obsop'];
                                                $rest=mysqli_query($koneksi, "SELECT observasi_open.id_lokasi, lokasi  FROM observasi_open, lokasi WHERE observasi_open.id_lokasi=lokasi.id_lokasi AND id_obsop='$id_obsop'");
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                                include('koneksi.php');
                                                $id_obsop=$_GET['id_obsop'];
                                                $rest=mysqli_query($koneksi, "SELECT observasi_open.id_bahaya, bahaya  FROM observasi_open, bahaya WHERE observasi_open.id_bahaya=bahaya.id_bahaya AND id_obsop='$id_obsop'");
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                                include('koneksi.php');
                                                $id_obsop=$_GET['id_obsop'];
                                                $rest=mysqli_query($koneksi, "SELECT observasi_open.id_departemen, departemen  FROM observasi_open, departemen WHERE observasi_open.id_departemen=departemen.id_departemen AND id_obsop='$id_obsop'");
                                        ...
                                        <a href="observasi_beranda.php" class="btn btn-success">Batal</a>
                                    </form>
                                </div>
                            </div>
                        </div>

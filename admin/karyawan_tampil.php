...
<head>
    ...
    <title>S A P | Administrator - Data Karyawan </title>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                             <a href="karyawan_tambah.php" class="btn btn-danger"> Tambah Data Karyawan</a>
                                     ...
                                     <thead>
                                            ...
                                            <tbody>
                                               <?php
                                                ...
                                                $queryview = mysqli_query($koneksi, " SELECT id_karyawan, nik, nama,jabatan, departemen FROM karyawan, jabatan, departemen WHERE karyawan.id_jabatan=jabatan.id_jabatan AND karyawan.id_departemen=departemen.id_departemen");
                                                while ($row = mysqli_fetch_assoc($queryview)) {
                                                    ...
                                                    ?>
                                                     ...
                                                     <tr>
                                                          ...
                                                          <td>
                                                             <a href="karyawan_edit.php<?php echo '?id_karyawan=' . $id_karyawan; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                                             <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#hapuskaryawan<?php echo $id_karyawan; ?>"><i class="fa fa-trash-o"></i></a>

                                                                  <div class="example-modal">
                                                                    <div id="hapuskaryawan<?php echo $id_karyawan; ?>" class="modal fade" role="dialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"  style="display:none;">
                                                                      <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                          <div class="modal-header">
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                            <h5 class="modal-title">Konformasi Hapus Data Karyawan</h5>
                                                                          </div>
                                                                          ...
                                                                          <div class="modal-footer">
                                                                            ...
                                                                            <a href="karyawan_hapus.php<?php echo '?id_karyawan=' . $id_karyawan; ?>" class="btn btn-primary">Hapus</a>
                                                                          </div>
                                                                        </div>
                                                                      </div>
                                                                    </div>

...
<head>
    ...
    <title>S A P | Tambah Data Karyawan </title>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Silakan Masukkan Data Karyawan
                       ...
                       <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                   <form role="form" method="POST" action="karyawan_tambah_proses.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            echo '<select name="id_jabatan" class="form-control" required>';

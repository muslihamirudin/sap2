                           ...
                           <?php
                            if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
                                ...
                                if($filter == '1'){ // Jika filter nya 1 (per tanggal)
                                    ...
                                    echo '<a href="observasi_close_cetak.php?filter=1&tgl_obscl='.$_GET['tanggal'].'" <button type="button" class="btn btn-warning waves-effect waves-light"> Cetak PDF</button></a>';
                                    ...
                                    echo '<a href="observasi_close_cetak.php?filter=2&bulan='.$_GET['bulan'].'&tahun='.$_GET['tahun'].'" <button type="button" class="btn btn-warning waves-effect waves-light"> Cetak PDF</button></a>';
                                    ...
                                    echo '<a href="observasi_close_cetak.php?filter=3&tahun='.$_GET['tahun'].'" <button type="button" class="btn btn-warning waves-effect waves-light"> Cetak PDF</button></a>';
                                ...
                                echo '<a href="observasi_close_cetak.php" button type="button" class="btn btn-warning waves-effect waves-light"> Cetak PDF</button></a><br /><br />';
                                    ...
                                    <tbody>
                                        <?php include ('koneksi.php'); 
                                              ...
                                              while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                                                ...
                                                echo "<td>"."<img src=assets/img/".$data['bukti_perbaikan']." height=60></td>";
                                                echo "<td>".$data['jenis_obsop']."</td>";
                                                echo "<td>".$data['nama_kary']."</td>";
                                                echo "<td>".$data['lokasi']."</td>";
                                                echo "<td>".$data['deskripsi']."</td>";
                                                echo "<td><img src=assets/img/".$data['bukti']." height=60></td>";

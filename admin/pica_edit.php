    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Lapor!</h1>
                </div>
                <!--End Page Header -->
            </div>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Silakan Edit Laporan Anda
                       ...
                       <div class="panel-body">
                            ...
                            $tampil= mysqli_query($koneksi, "SELECT * FROM pica_open WHERE id_picao='$id_picao'");
                            $row= mysqli_fetch_array($tampil);
                            ?>
                                <div class="col-lg-12">
                                 <form role="form" method="POST" action="pica_edit_proses.php" enctype="multipart/form-data">
                                        <input type="hidden" class="form-control" name="id_karyawan" value="<?php echo $_SESSION['id_karyawan']; ?>">
                                         <input type="hidden" class="form-control" name="fotolama" value="<?php echo $row["foto"]; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="due_tanggal" value="<?php echo $row['due_tanggal'] ?>">
                                        </div>
                                         <div class="form-group">
                                            <label>Deskripsi Bahaya</label>
                                            <input type=text" class="form-control" rows="3" name="desc_bahaya" value="<?php echo $row['desc_bahaya'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Rekomendasi Tindakan</label>
                                            <input type="text" name="rec_tindakan" class="form-control" rows="3" name="rec_tindakan" value="<?php echo $row['rec_tindakan'] ?>">
                                        </div>
                                         <div class="form-group">
                                            <label>Foto</label>
                                            </br> <img src="assets/img/<?php echo $row['foto'];?>" width="100">
                                            <span class="label-control"><?php echo $row['foto'];?> </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                                include('koneksi.php');
                                                $id_picao=$_GET['id_picao'];
                                                $rest=mysqli_query($koneksi, "SELECT pica_open.id_lokasi, lokasi  FROM pica_open, lokasi WHERE pica_open.id_lokasi=lokasi.id_lokasi AND id_picao='$id_picao'");
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                                include('koneksi.php');
                                                $id_picao=$_GET['id_picao'];
                                                $rest=mysqli_query($koneksi, "SELECT pica_open.id_bahaya, bahaya  FROM pica_open, bahaya WHERE pica_open.id_bahaya=bahaya.id_bahaya AND id_picao='$id_picao'");
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                                include('koneksi.php');
                                                $id_picao=$_GET['id_picao'];
                                                $rest=mysqli_query($koneksi, "SELECT pica_open.id_departemen, departemen  FROM pica_open, departemen WHERE pica_open.id_departemen=departemen.id_departemen AND id_picao='$id_picao'");

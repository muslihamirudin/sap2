...
<head>
    ...
    <title>S A P | Administrator - Data Pengguna </title>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                             <a href="pengguna_tambah.php" class="btn btn-danger"> Tambah Data Pengguna</a>
                                     ...
                                     <thead>
                                            ...
                                            <tbody>
                                               <?php
                                                ...
                                                $queryview = mysqli_query($koneksi, " SELECT id_user, nik, nama, username, password, level FROM info_login, karyawan WHERE info_login.id_karyawan=karyawan.id_karyawan ");
                                                while ($row = mysqli_fetch_assoc($queryview)) {
                                                    ...
                                                    ?>
                                                     ...
                                                     <tr>
                                                          ...
                                                          <td>
                                                             <a href="pengguna_edit.php<?php echo '?id_user=' . $id_user; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                                             <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#hapuspengguna<?php echo $id_user; ?>"><i class="fa fa-trash-o"></i></a>

                                                                  <div class="example-modal">
                                                                    <div id="hapuspengguna<?php echo $id_user; ?>" class="modal fade" role="dialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"  style="display:none;">
                                                                      <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                          ...
                                                                          <div class="modal-footer">
                                                                            ...
                                                                            <a href="pengguna_hapus.php<?php echo '?id_user=' . $id_user; ?>" class="btn btn-primary">Hapus</a>
                                                                          </div>
                                                                        </div>
                                                                      </div>
                                                                    </div>

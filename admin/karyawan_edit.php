...
<head>
    ...
    <title>S A P | Edit Data Karyawan </title>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Silakan Edit Data Karyawan
                       ...
                       <div class="panel-body">
                            ...
                            $tampil= mysqli_query($koneksi, "SELECT * FROM karyawan WHERE id_karyawan='$id_karyawan'");
                            $row= mysqli_fetch_array($tampil);
                            ?>
                                <div class="col-lg-12">
                                 <form role="form" method="POST" action="karyawan_edit_proses.php">
                                         <input type="hidden" class="form-control" name="id_karyawan" value="<?php echo $row["id_karyawan"]; ?>">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <?php
                                                include('koneksi.php');
                                                $id_karyawan=$_GET['id_karyawan'];
                                                $rest=mysqli_query($koneksi, "SELECT karyawan.id_jabatan, jabatan FROM karyawan, jabatan WHERE karyawan.id_jabatan=jabatan.id_jabatan AND id_karyawan='$id_karyawan'");
                                                while ($ar = mysqli_fetch_array($rest)) {
                                                    $id_jabatan = $ar['id_jabatan'];
                                                    $jabatan = $ar['jabatan'];
                                                }
                                                ?>
                                            <option value="<?php echo $id_jabatan; ?>"><?php echo $jabatan; ?></option>
                                                <?php
                                                include('koneksi.php');
                                                $result = mysqli_query($koneksi, "SELECT * FROM jabatan ORDER BY jabatan");
                                         ...
                                         <div class="form-group">
                                            ...
                                            <?php
                                                include('koneksi.php');
                                                $id_karyawan=$_GET['id_karyawan'];
                                                $rest=mysqli_query($koneksi, "SELECT karyawan.id_departemen, departemen FROM karyawan, departemen WHERE karyawan.id_departemen=departemen.id_departemen AND id_karyawan='$id_karyawan'");
                                                while ($ar = mysqli_fetch_array($rest)) {
                                                    $id_departemen = $ar['id_departemen'];
                                                    $departemen = $ar['departemen'];
                                                }
                                                ?>
                                        ...
                                        <a href="karyawan_tampil.php" class="btn btn-success">Batal</a>
                                    </form>
                                </div>
                            </div>
                        </div>

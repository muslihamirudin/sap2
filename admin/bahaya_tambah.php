...
<head>
    ...
    <title>S A P | Tambah Data Bahaya </title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Data Bahaya</h1>
                </div>
                <!--End Page Header -->
            </div>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Silakan Masukkan Data Bahaya
                       ...
                       <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                   <form role="form" method="POST" action="bahaya_tambah_proses.php">

                                        <div class="form-group">
                                            <label>Bahaya</label>
                                            <input type="text" class="form-control" name="bahaya" required>
                                        </div>

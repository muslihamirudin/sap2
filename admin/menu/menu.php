      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item"><a class="nav-link"> Selamat Datang Admin [
         ...
         <div class="row">
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="../observasi_beranda.php" class="block-20" style="background-image: url('images/Observasi2.jpg');"></a>
              <div class="text p-4 d-block">
                <h3 class="heading"><a href="../observasi_beranda.php">OBSERVASI</a></h3>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry" data-aos-delay="100">
              <a href="../inspeksi_beranda.php" class="block-20" style="background-image: url('images/Inspeksi.jpg');">
              </a>
              <div class="text p-4">
                <h3 class="heading"><a href="../inspeksi_beranda.php">INSPEKSI</a></h3>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry" data-aos-delay="200">
              <a href="../pica_beranda.php" class="block-20" style="background-image: url('images/hazard.jpg');">
              </a>
              <div class="text p-4">
                <h3 class="heading"><a href="../pica_beranda.php">HAZARD REPORT</a></h3>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="../pc_beranda.php" class="block-20" style="background-image: url('images/PC.jpg');">
              </a>
              <div class="text p-4 d-block">
                <h3 class="heading"><a href="../pc_beranda.php">PERSONAL CONTACT</a></h3>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry" data-aos-delay="200">
              <a href="../karyawan_tampil.php" class="block-20" style="background-image: url('images/image_4.jpg');">
              </a>
              <div class="text p-4">
                <h3 class="heading"><a href="../karyawan_tampil.php">ADMINISTRATOR</a></h3>
              </div>
            </div>
          </div>
        </div>

...
<head>
    ...
    <title>S A P | Administrator - Data Jabatan </title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Data Jabatan Karyawan</h1>
                </div>
                 <!-- end  page header -->
            </div>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                             <a href="jabatan_tambah.php" class="btn btn-danger"> Tambah Data Jabatan</a>
                                     ...
                                     <thead>
                                            ...
                                            <tbody>
                                               <?php
                                                ...
                                                $queryview = mysqli_query($koneksi, " SELECT id_jabatan, jabatan FROM jabatan");
                                                while ($row = mysqli_fetch_assoc($queryview)) {
                                                    ...
                                                    ?>
                                                     ...
                                                     <tr>
                                                          ...
                                                          <td>
                                                             <a href="jabatan_edit.php<?php echo '?id_jabatan=' . $id_jabatan; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                                             <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#hapusjabatan<?php echo $id_jabatan; ?>"><i class="fa fa-trash-o"></i></a>

                                                                  <div class="example-modal">
                                                                    <div id="hapusjabatan<?php echo $id_jabatan; ?>" class="modal fade" role="dialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"  style="display:none;">
                                                                      <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                          <div class="modal-header">
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                            <h5 class="modal-title">Konformasi Hapus Data Jabatan</h5>
                                                                          </div>
                                                                          ...
                                                                          <div class="modal-footer">
                                                                            ...
                                                                            <a href="jabatan_hapus.php<?php echo '?id_jabatan=' . $id_jabatan; ?>" class="btn btn-primary">Hapus</a>
                                                                          </div>
                                                                        </div>
                                                                      </div>
                                                                    </div>

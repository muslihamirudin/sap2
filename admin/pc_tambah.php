...
<head>
    ...
    <title>S A P | Tambah Personal Contact </title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Personal Contact!</h1>
                </div>
                <!--End Page Header -->
            </div>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Silakan Masukkan Personal Contact Anda
                       ...
                       <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                 <form role="form" method="POST" action="pc_tambah_proses.php">

                                        <div class="form-group">
                                            <label>Tanggal</label>
                                            <input type="date" class="form-control" name="tgl_pc">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            echo '<select name="name_karyawan" class="form-control" required>';
                                        ...
                                        <div class="form-group">
                                            <label>Masalah</label>
                                            <textarea class="form-control" rows="3" name="masalah"></textarea>
                                        </div>
                                         <div class="form-group">
                                            <label>Solusi</label>
                                            <textarea class="form-control" rows="3" name="rec_solusi"></textarea>
                                        </div>

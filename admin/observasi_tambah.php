    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Observasi</h1>
                </div>
                <!--End Page Header -->
            </div>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Silakan Masukkan Observasi Anda
                       ...
                       <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                      <form role="form" method="POST" action="observasi_tambah_proses.php" enctype="multipart/form-data">

                                        <div class="form-group">
                                            <label>Tanggal</label>
                                            <input type="date" class="form-control" name="tgl_obsop" required>
                                        </div>

                                        <div class="form-group">
                                            <label>Batas Tanggal</label>
                                            <input type="date" class="form-control" name="due_obsop" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            echo '<select name="nama_kary" class="form-control" required>';
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" name="rec" required></textarea>
                                        </div>
                                          <div class="form-group">
                                            <label>Bukti</label>
                                            <input type="file" id="file-input" name="bukti" class="form-control -file" value="<?php echo $row['bukti']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Bahaya</label>
                                            <?php
                                        ...
                                        <button type="submit" class="btn btn-primary">Observasi !</button>

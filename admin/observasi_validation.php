...
<head>
    ...
    <title>S A P | Observasi Validation </title>
                                      ...
                                      <?php
                                            ...
                                            ?>
                                             <tr>
                                                  ...
                                                  <td><img src="assets/img/<?php echo $row['bukti_perbaikan'];?>" height="50"></td>
                                                  <td><?php echo $row['jenis_obsop']; ?></td>
                                                  <td><?php echo $row['nama_kary']; ?></td>
                                                  <td><?php echo $row['lokasi']; ?></td>
                                                  <td><?php echo $row['deskripsi']; ?></td>
                                                   <td><img src="assets/img/<?php echo $row['bukti'];?>" height="40"></td>

...
<head>
    ...
    <title>S A P | Edit Data Lokasi </title>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Silakan Edit Data Lokasi
                       ...
                       <div class="panel-body">
                          ...
                          <?php
                            ...
                            $tampil= mysqli_query($koneksi, "SELECT * FROM lokasi WHERE id_lokasi='$id_lokasi'");
                            $row= mysqli_fetch_array($tampil);
                            ?>
                                <div class="col-lg-12">
                                  <form role="form" method="POST" action="lokasi_edit_proses.php">
                                        ...
                                        <a href="lokasi_tampil.php" class="btn btn-success">Batal</a>
                                    </form>
                                </div>
                            </div>
                        </div>

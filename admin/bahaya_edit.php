...
<head>
    ...
    <title>S A P | Edit Data Bahaya </title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Data Bahaya</h1>
                </div>
                <!--End Page Header -->
            </div>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Silakan Edit Data Jenis Bahaya
                       ...
                       <div class="panel-body">
                           ...
                           <?php
                            ...
                            $tampil= mysqli_query($koneksi, "SELECT * FROM bahaya WHERE id_bahaya='$id_bahaya'");
                            $row= mysqli_fetch_array($tampil);
                            ?>
                                <div class="col-lg-12">
                                  <form role="form" method="POST" action="bahaya_edit_proses.php">
                                         <input type="hidden" class="form-control" name="id_bahaya" value="<?php echo $row["id_bahaya"]; ?>">

                                        <div class="form-group">
                                            <label>Bahaya</label>
                                            <input type="text" class="form-control" name="bahaya" value="<?php echo $row["bahaya"]; ?>">
                                        </div>

                                        <div class="form-group">
                                            <label>Tindakan</label>
                                            <input type="text" class="form-control" name="tindakan" value="<?php echo $row["tindakan"]; ?>">
                                        </div>

                                        <button type="submit" class="btn btn-primary">Edit</button>
                                        <a href="bahaya_tampil.php" class="btn btn-success">Batal</a>
                                    </form>
                                </div>
                            </div>
                        </div>

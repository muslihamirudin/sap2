    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Laporan PICA CLOSE</h1>
                </div>
                 <!-- end  page header -->
            </div>
                ...
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Berikut merupakan Laporan PICA CLOSE
                       ...
                       <div class="panel-body">
                        ...
                        <script src="js/jquery.min.js"></script> <!-- Load file jquery -->
                         ...
                         <form method="get" action="">
                            ...
                            <option value="">Pilih</option>
                            <?php
                            $query = "SELECT YEAR(tanggal_perbaikan) AS tahun FROM pica_close GROUP BY YEAR(tanggal_perbaikan)"; // Tampilkan tahun sesuai di tabel transaksi
                            ...
                            <a href="pica_close.php" <button type="button" class="btn btn-danger waves-effect waves-light"> Reset Filter </button> </a>
                        </form>
                           ...
                           <?php
                            if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
                                ...
                                if($filter == '1'){ // Jika filter nya 1 (per tanggal)
                                    ...
                                    echo '<a href="pica_close_cetak.php?filter=1&tanggal_perbaikan='.$_GET['tanggal'].'" <button type="button" class="btn btn-warning waves-effect waves-light"> Cetak PDF</button></a>';

                                    $query = "SELECT id_picac, tanggal_perbaikan, foto_perbaikan, tanggal, due_tanggal, lokasi, desc_bahaya, foto, bahaya, rec_tindakan, nama, departemen AS 'Penanggung Jawab' FROM pica_close, pica_open, bahaya, karyawan, lokasi, departemen WHERE pica_close.id_picao=pica_open.id_picao AND pica_open.id_bahaya=bahaya.id_bahaya AND pica_open.id_karyawan=karyawan.id_karyawan AND pica_open.id_departemen=departemen.id_departemen AND pica_open.id_lokasi=lokasi.id_lokasi AND validasi=1 AND DATE(tanggal_perbaikan)='".$_GET['tanggal']."'"; // Tampilkan data laporan sesuai tanggal yang diinput oleh user pada filter
                                }else if($filter == '2'){ // Jika filter nya 2 (per bulan)
                                    $nama_bulan = array('', 'Januari','Februari','Maret','April','Mei','Juni','Juli','Agustus','September','Oktober','November','Desember');

                                    echo '<h3>Data Laporan Bulan '.$nama_bulan[$_GET['bulan']].' '.$_GET['tahun'].'</h3>';
                                    echo '<a href="pica_close_cetak.php?filter=2&bulan='.$_GET['bulan'].'&tahun='.$_GET['tahun'].'" <button type="button" class="btn btn-warning waves-effect waves-light"> Cetak PDF</button></a>';
                                    ...
                                    echo '<a href="pica_close_cetak.php?filter=3&tahun='.$_GET['tahun'].'" <button type="button" class="btn btn-warning waves-effect waves-light"> Cetak PDF</button></a>';
                                ...
                                echo '<a href="pica_close_cetak.php" button type="button" class="btn btn-warning waves-effect waves-light"> Cetak PDF</button></a><br/ > <br />';
                                    ...
                                    <tbody>
                                       <?php include ('koneksi.php'); 
                                              ...
                                              while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                                                ...
                                                $no++;
                                                $id_picao= $data['id_picac'];


                                                echo "<tr>";
                                                echo "<td>".$data['id_picac']."</td>";
                                                echo "<td>".fungsi_tanggal($data['tanggal_perbaikan'])."</td>";
                                                echo "<td><img src=assets/img/".$data['foto_perbaikan']." height=50></td>";
                                                echo "<td>".fungsi_tanggal($data['tanggal'])."</td>";
                                                echo "<td>".fungsi_tanggal($data['due_tanggal'])."</td>";
                                                echo "<td>".$data['lokasi']."</td>";
                                                echo "<td>".$data['desc_bahaya']."</td>";
                                                echo "<td><img src=assets/img/".$data['foto']." height=50></td>";
                                                echo "<td>".$data['bahaya']."</td>";
                                                echo "<td>".$data['rec_tindakan']."</td>";
                                                echo "<td>".$data['nama']."</td>";
                                                echo "<td>".$data['Penanggung Jawab']."</td>";
                                                echo "</tr>";
                                                 }

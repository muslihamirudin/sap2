    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Dashboard Observasi</h1>
                </div>
                 <!-- end  page header -->
            </div>
            ...
            <div class="row">
             ...
             <div class="row">
                <div class="col-lg-12">
                  <div class="panel panel-primary">
                     <div class="panel-heading">
                            <i class="fa fa-flag fa-fw"></i> Data Observasi Anda: <?php $id_karyawan = $_SESSION['id_karyawan']; $query = mysqli_query($koneksi, "SELECT nama FROM karyawan WHERE id_karyawan='$id_karyawan'");
                                while ($apakah=mysqli_fetch_object($query))
                                {
                                  echo $apakah->nama." " ;
                                }?> &nbsp|&nbsp <a href="observasi_tambah.php" class="btn btn-danger"> Mulai Observasi ! </a>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                      <?php
                                                ...
                                                $queryview = mysqli_query($koneksi, " SELECT id_obsop, tgl_obsop, due_obsop, a.nama AS nama_kary, lokasi, deskripsi, bukti, bahaya, rec, departemen, jenis_obsop, status FROM observasi_open, karyawan AS a, lokasi, bahaya, departemen WHERE observasi_open.nama_kary=a.id_karyawan AND observasi_open.id_lokasi=lokasi.id_lokasi AND observasi_open.id_bahaya=bahaya.id_bahaya AND observasi_open.id_departemen=departemen.id_departemen AND observasi_open.observ='$id_karyawan' ORDER BY bahaya");
                                                while ($row = mysqli_fetch_assoc($queryview)) {
                                                    ...
                                                    ?>
                                                     ...
                                                     <tr>
                                                          ...
                                                          <td><?php echo $no++;?></td>
                                                          <td><?=  fungsi_tanggal($row['tgl_obsop']); ?></td>
                                                          <td><?=  fungsi_tanggal($row['due_obsop']); ?></td>
                                                          <td><?php echo $row['nama_kary']; ?></td>
                                                          <td width="4%"><?php echo $row['lokasi']; ?></td>
                                                          <td width="5%"><?php echo $row['deskripsi']; ?></td>
                                                          <td><img src="assets/img/<?php echo $row['bukti'];?>" height="35"></td>
                                                          <td><?php echo $row['bahaya']; ?></td>
                                                          <td width="5%"><?php echo $row['rec']; ?></td>
                                                          ...
                                                          <td width="5%"> <?php
                                                                if ($row['status'] == 0){
                                                                     ?> <a href="observasi_edit.php<?php echo '?id_obsop=' . $id_obsop; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a> <?php ;
                                                                } else if ($row['status'] == 1) {
                                                                ...
                                                                <br />
                                                                 <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#hapuslapor<?php echo $id_obsop; ?>"><i class="fa fa-trash-o"></i></a>

                                                                  <div class="example-modal">
                                                                    <div id="hapuslapor<?php echo $id_obsop; ?>" class="modal fade" role="dialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"  style="display:none;">
                                                                      <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                          ...
                                                                          <div class="modal-footer">
                                                                            ...
                                                                            <a href="observasi_hapus.php<?php echo '?id_obsop=' . $id_obsop; ?>" class="btn btn-primary">Hapus</a>
                                                                          </div>
                                                                        </div>
                                                                      </div>
                                                                    </div>
